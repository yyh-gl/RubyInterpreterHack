...
DEFS = 
CPPFLAGS = -I/usr/local/opt/imagemagick@6/include -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags) -DONIG_ENC_REGISTER=rb_enc_register
LDFLAGS = -L. -L/usr/local/opt/imagemagick@6/lib -fstack-protector -L/usr/local/lib
LDSHARED = $(CC) -dynamic -bundle
ldflags  = $(LDFLAGS)
dldflags = -L/usr/local/opt/imagemagick@6/lib -Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress
extdldflags = 
archflag = 
...
LIBPATH =  -L. -L$(topdir)
LIBS = $(LIBRUBYARG_SHARED) -lpthread -lgmp -ldl -lobjc $(EXTLIBS)
