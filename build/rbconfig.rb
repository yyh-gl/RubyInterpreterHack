...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/Y_h/.rbenv/versions/rubyhackchallenge/build/../install")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/Y_h/.rbenv/versions/rubyhackchallenge/build/../install' '--enable-shared' 'LDFLAGS=-L/usr/local/opt/imagemagick@6/lib' 'CPPFLAGS=-I/usr/local/opt/imagemagick@6/include'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/Y_h/.rbenv/versions/rubyhackchallenge/build/../install"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/usr/local/opt/imagemagick@6/lib -Wl,-undefined,dynamic_lookup -Wl,-multiply_defined,suppress"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/usr/local/opt/imagemagick@6/include -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/usr/local/opt/imagemagick@6/lib -fstack-protector -L/usr/local/lib"
